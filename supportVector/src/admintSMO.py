...
if __name__ == '__main__':
    dataArr, classLabels = loadDataSet(r'F:\Machine-Learning-master\Machine-Learning-master\Logistic\ex2data1.txt')
    for i in range(len(classLabels)):
        if classLabels[i] == float(0):
            classLabels[i] = -1
    b, alphas = smoP(dataArr, classLabels, 1, 0.01, 10)
